...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleRouting() {
        ...
        if (!['#/', '#/about', '#/products', '#/infrastructure', '#/contact'].includes(routeBase)) {
            routeBase = '#/';
        }
    ...
    menuToggleBtn.addEventListener('click', () => {
        ...
        // Simple animation logic for three span bars inside hamburger button
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', (e) => {
            ...
            let existingSubmissions = JSON.parse(localStorage.getItem('vr_inquiries') || '[]');
