...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const PRODUCTS_CATALOG = [
        ...
        },
        {
            ...
            shortDesc: 'Durable and eco-friendly protective storage bag made from high-quality non-woven fabric.',
            desc: 'Non-Woven Shoe Bag is a durable and eco-friendly storage bag made from high-quality non-woven fabric. It helps protect shoes from dust, moisture, and scratches, making it ideal for travel, retail packaging, gifting, and home storage.',
            features: [
                'Made from premium non-woven polypropylene fabric',
                'Lightweight, breathable and reusable',
                'Dust-resistant and moisture-resistant protection',
                'Drawstring, zipper, or handle options available',
                'Custom printing, branding, and sizing available'
            ],
            gsm: '40 - 120 GSM (customizable)',
            tensile: 'Non-Woven Fabric (PP)',
            widths: 'Drawstring, Zipper, or Handle Options',
            lengths: 'Customized as per requirement',
            applications: 'Screen Printing, Flexo Printing, Offset Printing, or Custom Branding',
            image: 'assets/product-shoe-bag.jpg',
            crops: ['center']
        },
        {
            id: 'gift-hamper-bag',
            category: 'bags',
            categoryName: 'Carry Bags',
            name: 'Non-Woven Gift Hamper Bag',
            shortDesc: 'Elegant and premium packaging solution designed for gift hampers, corporate gifting, and weddings.',
            desc: 'Non-Woven Gift Hamper Bag is an elegant and eco-friendly packaging solution designed for gift hampers, festive gifts, corporate gifting, wedding favors, and premium product presentations. Made from durable non-woven fabric, it offers a stylish appearance while being reusable and environmentally friendly.',
            features: [
                'Elegant premium aesthetics for high-end gifting',
                'Durable, strong construction with handles',
                'Eco-friendly, reusable alternative to plastic boxes',
                'Ideal for corporate, festive, and wedding return gifts'
            ],
            gsm: '60 - 140 GSM',
            tensile: 'Non-Woven Fabric (PP)',
            widths: 'Premium Hamper Style with Optional Display Window',
            lengths: 'Customized as per requirement',
            applications: 'Festive hamper gifting, corporate events, dry fruit/sweet box packaging',
            image: 'assets/product-gift-hamper-bag.jpg',
            crops: ['center']
        },
        {
            id: 'disposable-apron',
            category: 'bags',
            categoryName: 'Disposable Wear',
            name: 'Non-Woven Disposable Apron',
            shortDesc: 'Lightweight, hygienic, single-use protective apron made from non-woven polypropylene fabric.',
            desc: 'Non-Woven Disposable Apron is a lightweight, single-use protective apron made from non-woven polypropylene fabric. It is commonly used in restaurants, food processing units, sweet shops (Mithai shops), bakeries, hospitals, clinics, salons, spas, housekeeping, and cleaning services.',
            features: [
                'Lightweight, comfortable, and breathable design',
                'Water-resistant, dust-resistant, and splash-proof',
                'Hygienic single-use protection for various industries',
                'Available in multiple clean color selections'
            ],
            gsm: '20 - 50 GSM (lightweight)',
            tensile: 'Non-Woven Polypropylene (PP)',
            widths: 'Halter Neck Tie-Back Apron Design',
            lengths: 'One Size Fits All / Custom size available as per order',
            applications: 'Food service, bakeries, sweet shops, hospitals, housekeeping, salons & spas',
            image: 'assets/product-disposable-apron.jpg',
            crops: ['center']
        }
    ];

    // --- PRODUCT GALLERY ITEMS DATA ---
    const GALLERY_ITEMS = [
        {
            id: 'gal-1',
    ...
    const SEO_META_MAP = {
        ...
        '#/contact': {
            ...
            description: 'Send an inquiry to vrinddewas@gmail.com. Get in touch with Vinay Jain or Rahil Jain, and find directions to our Dewas plant.'
        },
        '#/customers': {
        ...
        '#/gallery': {
            title: 'Product Gallery | Custom Manufactured Carry Bags | VR Industries',
            description: 'Explore the product gallery of custom W-cut, D-cut, loop handle, and box carry bags made at our Dewas manufacturing plant.'
        }
    };
    ...
    const galleryGrid = document.getElementById('gallery-showcase-grid');
    ...
    function handleRouting() {
        ...
        if (!['#/', '#/about', '#/products', '#/infrastructure', '#/contact', '#/customers', '#/gallery'].includes(routeBase)) {
            routeBase = '#/';
        }
        ...
        } else if (routeBase === '#/gallery') {
            renderGalleryGrid('all');
            if (galleryFilterTabs) {
                galleryFilterTabs.querySelectorAll('.filter-btn').forEach(btn => {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', (e) => {
            ...
            // Submit form to Web3Forms asynchronously
            fetch('https://api.web3forms.com/submit', {
                ...
                body: JSON.stringify({
                    access_key: '31f08a73-a216-4ef9-a155-7f03daec75f6',
    ...
    function triggerSimulatedEmails(inquiry) {
        ...
        const inboundEmail = {
            ...
            to: 'VR Industries Sales <vrinddewas@gmail.com>',
...
VR Core Automated Lead Hub`
        ...
        const outboundEmail = {
            ...
            direction: 'outbound',
            from: 'VR Industries Sales <vrinddewas@gmail.com>',
...
Web: www.vr-industries.co | Tel: +91 7049493600 | WhatsApp: +91 9165690656`
        };
    ...
    function renderGalleryGrid(categoryFilter) {
        ...
        if (filteredList.length === 0) {
            galleryGrid.innerHTML = `
                <div style="grid-column: 1/-1; text-align: center; color: var(--text-secondary); padding: 60px 20px; background-color: var(--bg-secondary); border: 1px dashed var(--border-color); border-radius: 8px; max-width: 600px; margin: 40px auto; box-shadow: var(--shadow-sm);">
                    <div style="font-size: 3rem; margin-bottom: 20px; filter: drop-shadow(0 2px 8px rgba(0,0,0,0.1));">📸</div>
                    <h4 style="font-family: var(--font-heading); font-size: 1.25rem; color: var(--text-primary); margin-bottom: 10px;">Gallery Showcase Coming Soon</h4>
                    <p style="font-size: 0.95rem; line-height: 1.6; max-width: 480px; margin: 0 auto; color: var(--text-secondary);">We are currently updating our portfolio with recent product imagery. High-quality pictures of custom printed W-cut, D-cut, and loop handle carry bags made at our Dewas facility will be showcased here shortly.</p>
                </div>
            `;
            return;
        }
        ...
        filteredList.forEach(item => {
            ...
            card.innerHTML = `
                <div class="gallery-item-image-wrap" style="height: 100%; width: 100%;">
                    <img src="${item.image}" alt="Manufactured Carry Bag from VR Industries" class="gallery-item-img" style="display: block; width: 100%; height: 100%; object-fit: cover;">
                </div>
            `;
            
            card.addEventListener('click', () => {
                openGalleryLightbox(item.image);
            });
    ...
    function openGalleryLightbox(imgSrc) {
        ...
        if (!lightbox) {
            ...
            lightbox.className = 'cert-overlay'; // Reuse cert overlay class for styling
            lightbox.innerHTML = `
                <div class="cert-overlay-content" style="max-width: 800px; background-color: transparent; box-shadow: none; border: none;">
                    <button class="cert-close-btn" id="gallery-lightbox-close" style="top: 10px; right: 10px;">&times;</button>
                    <img src="" alt="Enlarged gallery product view" id="gallery-lightbox-img" style="width: 100%; height: auto; border-radius: 8px; box-shadow: var(--shadow-2xl); display: block;">
                </div>
            `;
    ...
    // Handle gallery filter tabs click (safe fallback if tabs exist)
    if (galleryFilterTabs) {
        galleryFilterTabs.addEventListener('click', (e) => {
            ...
            const targetFilter = filterBtn.getAttribute('data-filter');
            renderGalleryGrid(targetFilter);
        });
    }
});
